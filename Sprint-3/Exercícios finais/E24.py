...
#Instancie um objeto chamado crescente dessa classe Ordenadora que 
# tenha como listaBaguncada a lista [3,4,2,1,5] e instancie um outro 
# objeto, decrescente dessa mesma classe com uma outra listaBaguncada sendo [9,7,6,8].
